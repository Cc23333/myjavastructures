...
import com.structures.tree.binarytree.BinaryNode;
import com.structures.tree.binarytree.Tree;

/**
 * @program: myjavastructures
 * @description: 平衡二叉搜索树（AVL树）
 * @author: Cc.
 * @create: 2019-04-14 15:42
 **/
...
public class AVLTree<T extends Comparable> implements Tree<T> {
    ...
    */
    ...
    public boolean contains(T data) throws Exception {
        return data != null && contains(data, root);
    }
    public boolean contains(T data , AVLNode<T> subtree){
        ...
        if (result<0){
            return contains(data,subtree.left);
        }else if(result>0){
            return contains(data,subtree.right);
        }else {
            return true;
        }
    }
    ...
    /** 
    * @Description: 左左单旋转(LL旋转) w变为x的根结点, x变为w的右子树
    * @Param: [x]
    * @return: com.structures.tree.avltree.AVLNode<T>
    * @Author: Cc.
    * @Date: 2019/4/14
    */ 
